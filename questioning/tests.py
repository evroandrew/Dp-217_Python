...
class GenResultTestCase(TestCase):
    ...
    def test_gen_result(self):
        test_answer = {
            ...
            'field_0': [['Посилання на пошук:', ''], ['09 Біологія', '09_Біологія'],
            ...
            'field_1': [['Посилання на пошук:', ''], ['13 Механічна інженерія', '13_Механічна_інженерія'],
            ...
            'field_2': [['Посилання на пошук:', ''], ['01 Освіта', '01_Освіта'],
                        ...
                        ['26 Цивільна безпека', '26_Цивільна_безпека'], ['28 Публічне управління і адміністрування',
